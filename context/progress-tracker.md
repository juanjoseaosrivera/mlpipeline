...
- **Current phase:** Phase 5 — CI/CD
- **Overall status:** Phases 0–4 complete. Phase 5 mostly done: coverage gates, image build + GHCR push, and pipeline timeouts in place. Branch protection on `main` blocked on repo visibility (GitHub Pro / public required on free plans).
